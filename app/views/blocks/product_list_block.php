              ...
              <div class="d-flex flex-column align-items-center bd-highlight mb-3">
                  ...
                  <div class="p-1 bd-highlight mt-5">
                      <div class="img_text">
                          ...
                          <a href="#" class="bottom-left-2 fs-3">Laptop Stands &nbsp <i class="bi bi-arrow-right "></i></a>
              ...
              <div class="col-4 mb-5">
                  <div class="card" style="width: 25rem;">
                      ...
                      <div class="card-body">
                          ...
                          <!-- Button add to card -->
                          <form method="post">
                            <input id="productId" type="hidden" name="productId" value="<?php  echo $product['id']?>">
                            <input id="quantity" type="hidden" name="quantity" value="1">
                            <input id="price" type="hidden" name="price" value="<?php  echo $product['price']?>">
                          <button onclick="sendData()" class="CartBtn">
